...
const Terms = () => {
  return (
    <>
      <div style={{ marginTop: '7vw !important', padding: '60px 15%' }} className={styles.po}>
        <h1>Terms of Use</h1>
        ...
        <div>
          ...
          <p>
            ...
            personally or on behalf of an entity (“you”) and DecorMatters, Inc. (“we,” “us” or
            “our”), concerning your access to and use of the https://www.decormatters.com website as
            well as any other media form, media channel, mobile website or mobile application
            related, linked, or otherwise connected thereto (collectively, the “Site”). You agree
          ...
          <div>
            ...
            <ol>
              ...
              <li>
                Except as may be the result of standard search engine or Internet br/owser usage,
          ...
          <div>
            ...
            create, submit, post, display, transmit, perform, publish, distribute, or br/oadcast
          ...
          <p>
            ...
            reproduce, disclose, sell, resell, publish, br/oadcast, retitle, archive, store, cache,
          ...
          <br />
          <h4>
            <span style={{ fontWeight: '500' }}>Use License</span>
          </h4>
          <p>
            ...
            application; (4) remove, alter, or obscure any proprietary notice (including any notice
            of copyright or trademark) posted by us or the licensors of the application; (5) use the
            application for any revenue generating endeavor, commercial enterprise, or other purpose
            for which it is not designed or intended; (6) make the application available over a
            network or other environment permitting access or use by multiple devices or users at
            the same time; (7) use the application for creating a product, service, or software that
            is, directly or indirectly, competitive with or in any way a substitute for the
            application; (8) use the application to send automated queries to any website or to send
            any unsolicited commercial e-mail; or (9) use any proprietary information or any of our
          ...
          <br />
          <h4>
            <span style={{ fontWeight: '500' }}>Apple and Android Devices</span>
          </h4>
          <p>
            ...
            any maintenance and support services with respect to the mobile application as specified
            in the terms and conditions of this mobile application license contained in these Terms
            ...
            when using the mobile application, e.g., if you have a VoIP application, then you must
            not be in violation of their wireless data service agreement when using the mobile
            application; and (6) you acknowledge and agree that the App Distributors are third-party
            beneficiaries of the terms and conditions in this mobile application license contained
            in these Terms of Use, and that each App Distributor will have the right (and will be
          ...
          <p>
            ...
            us and/or grant us access to your Third-Party Account, without br/each by you of any of
            the terms and conditions that govern your use of the applicable Third-Party Account, and
            ...
            your Third-Party Account (the “Social Network Content”) so that it is available on and
            through the Site via your account, including without limitation any friend lists and (2)
            ...
            the Site. Please note that if a Third-Party Account or associated service becomes
            ...
            the Site and your Third-Party Accounts at any time. PLEASE NOTE THAT YOUR RELATIONSHIP
            ...
            book associated with a Third-Party Account and your contacts list stored on your mobile
          ...
          <p>
            ...
            <a href="/policy"> Privacy Policy</a>. By using the Site, you agree to be bound by our
            Privacy Policy, which is incorporated into these Terms of Use. Please be advised the
            Site is hosted in the United States. If you access the Site from the European Union,
            ...
            and processed in the United States. Further, we do not knowingly accept, request, or
          ...
          <p>
            ...
            if you are not sure that material located on or linked to by the Site infringes your
          ...
          <p>
            ...
            REASON, INCLUDING WITHOUT LIMITATION FOR br/EACH OF ANY REPRESENTATION, WARRANTY, OR
          ...
          <p>
            ...
            entirely performed within the the State of California, without regard to its conflict of
            law principles.
          </p>
          <br />
          <h4>DISPUTE RESOLUTION</h4>
          <p>
            Any legal action of whatever nature br/ought by either you or us (collectively, the
            “Parties” and individually, a “Party”) shall be commenced or prosecuted in the state and
            federal courts located in Milpitas County, CA, and the Parties hereby consent to, and
          ...
          <p>
            ...
            Contributions; (2) use of the Site; (3) br/each of these Terms of Use; (4) any br/each
            of your representations and warranties set forth in these Terms of Use; (5) your
          ...
          <h4>COIN TIPS</h4>
          <p>
            By virtually sending coin tips to others, you acknowledge and understand that
            DecorMatters receives 20% of the total coins being transferred to other users as a
